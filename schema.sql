...
('name','MarTed'),
('subtitle','монтаж на мебели'),
('tagline','Фирма за монтаж и демонтаж'),
('phone','0898 535 885'),
('phoneHref','tel:+359898535885'),
('email','marted.montaj@gmail.com'),
('location','гр. Добрич и околността'),
('region','Работим в Добрич, Балчик, Варна и околността'),
('hours','Пон – Нед: 08:00 – 20:00'),
('established','2019'),
...
('500+','Доволни клиенти',1),
('1200+','Монтирани мебели',2),
('5+','Години опит',3),
('Добрич','и околността',4);
