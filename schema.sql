-- MySQL schema for MarTed (proper UTF-8)
...
CREATE TABLE IF NOT EXISTS bookings (
  ...
  email VARCHAR(160), service VARCHAR(160), notes TEXT, status VARCHAR(20) DEFAULT 'pending', created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('name','MarTed'),
('subtitle','Ð¼Ð¾Ð½Ñ‚Ð°Ð¶ Ð½Ð° Ð¼ÐµÐ±ÐµÐ»Ð¸'),
('tagline','Ð¤Ð¸Ñ€Ð¼Ð° Ð·Ð° Ð¼Ð¾Ð½Ñ‚Ð°Ð¶ Ð¸ Ð´ÐµÐ¼Ð¾Ð½Ñ‚Ð°Ð¶'),
('phone','0898 535 885'),
('phoneHref','tel:+359898535885'),
('email','marted.montaj@gmail.com'),
('location','Ð³Ñ€. Ð”Ð¾Ð±Ñ€Ð¸Ñ‡ Ð¸ Ð¾ÐºÐ¾Ð»Ð½Ð¾ÑÑ‚Ñ‚Ð°'),
('region','Ð Ð°Ð±Ð¾Ñ‚Ð¸Ð¼ Ð² Ð”Ð¾Ð±Ñ€Ð¸Ñ‡, Ð‘Ð°Ð»Ñ‡Ð¸Ðº, Ð’Ð°Ñ€Ð½Ð° Ð¸ Ð¾ÐºÐ¾Ð»Ð½Ð¾ÑÑ‚Ñ‚Ð°'),
('hours','ÐŸÐ¾Ð½ â€“ ÐÐµÐ´: 08:00 â€“ 20:00'),
('established','2019'),
...
('home_hero_image','/assets/media/hero-kitchen.jpg'),
('about_heading','ÐŸÑŠÑ€Ð²Ð¾ ÑÐµ ÑƒÑ‚Ð¾Ñ‡Ð½ÑÐ²Ð° Ð·Ð°Ð´Ð°Ñ‡Ð°Ñ‚Ð°. Ð¡Ð»ÐµÐ´ Ñ‚Ð¾Ð²Ð° ÑÐµ Ñ€Ð°Ð±Ð¾Ñ‚Ð¸.'),
...
('500+','Ð”Ð¾Ð²Ð¾Ð»Ð½Ð¸ ÐºÐ»Ð¸ÐµÐ½Ñ‚Ð¸',1),
('1200+','ÐœÐ¾Ð½Ñ‚Ð¸Ñ€Ð°Ð½Ð¸ Ð¼ÐµÐ±ÐµÐ»Ð¸',2),
('5+','Ð“Ð¾Ð´Ð¸Ð½Ð¸ Ð¾Ð¿Ð¸Ñ‚',3),
('Ð”Ð¾Ð±Ñ€Ð¸Ñ‡','Ð¸ Ð¾ÐºÐ¾Ð»Ð½Ð¾ÑÑ‚Ñ‚Ð°',4);
