...
<link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Spectral:wght@400;600;700&family=Manrope:wght@400;600;700&family=JetBrains+Mono:wght@400;700&display=swap" onload="this.rel='stylesheet'">
...
<div class="adminLayout">
  ...
  <aside class="adminSidebar">
    <div class="adminSidebarLogo"><img src="/assets/media/logo.webp" alt="<?= e($s['name']) ?>" style="height:40px;width:auto"></div>
    <nav class="adminNav">
