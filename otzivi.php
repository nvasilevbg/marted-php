...
<section class="pageHero">
  <div class="container pageHeroInner">
    ...
    <p>Един отзив отнема минута, а на нас помага повече от вячка реклама.</p>
    <div class="reviewCTAWrap">
      ...
      <a class="btn btn-ghost reviewFbBtn" href="<?= e($s['facebook']) ?>" target="_blank" rel="noopener noreferrer"><?= icon('facebook') ?> Facebook</a>
      <?php endif; ?>
    </div>
  </div>
</section>
