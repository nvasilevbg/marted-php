...
<section class="pageHero">
  <div class="container pageHeroInner" style="text-align:center">
    ...
    <h1>Добре ли се справихме? <em>Кажете го.</em></h1>
    <p>Един отзив отнема само минута, а за нас значи повече от всяка реклама.</p>
...
<section class="section">
  <div class="container" style="max-width:640px">
    <div class="reviewTips">
      ...
      <ol>
        <li><strong>Къде беше обектът</strong> — Добрич, Балчик, Варна или друго</li>
        <li><strong>Какво правихме</strong> — монтаж на кухня, гардероб, спалня или демонтаж при пренасяне</li>
        <li><strong>Как мина работата</strong> — бързи ли бяхме, чисто ли оставихме, как се разбрахме</li>
      </ol>
    </div>
  </div>
</section>
