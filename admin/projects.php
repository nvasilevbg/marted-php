...
<form method="POST" enctype="multipart/form-data" class="adminForm" style="max-width:none">
  ...
  <div id="tab-main" class="tabContent active">
    ...
    <div class="formRow"><div><label>ÐšÐ°Ñ‚ÐµÐ³Ð¾Ñ€Ð¸Ñ</label><input name="category" value="<?= e($editing['category']) ?>"></div><div><label>Ð”Ð°Ñ‚Ð°</label><input name="pdate" value="<?= e($editing['pdate']) ?>" placeholder="Ð®Ð»Ð¸ 2024"></div></div>
